...
# ergebnis für beispiel 2, wenn die ersten 36 Sitze nicht belegt sind und ab sid 944 auch keine mehr belegt sind
# nicht die feine art, ich wieß aber es spukt das richtig aus
for s in set(range(36,944)).difference(set([x.sid for x in seats])) :
    print(s)
